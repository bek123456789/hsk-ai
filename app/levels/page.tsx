  ...
  return (
    ...
    <section className="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:py-14">
      <div className="mb-10 max-w-4xl">
        <p className="text-sm font-black uppercase tracking-normal text-orange-deep">HSK</p>
        <h1 className="mt-2 text-5xl font-black leading-tight text-ink sm:text-7xl">{t("levels.title")}</h1>
